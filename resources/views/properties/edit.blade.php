            ...
            <div class="box-body">
                ...
                <div class="form-group ">
                    ...
                    <select name="user_id" class="form-control">
                        ...
                        <option value="{{ $user->id}}" {{ $user->id == $row->user_id ? 'selected' : '' }}>{{ $user->fullName() }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group ">
                    ...
                    <input id="price" type="number" class="form-control @error('price') is-invalid @enderror"
                        name="price" value="{{ $row->price }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input id="baths_num" type="number"
                                class="form-control @error('baths_num') is-invalid @enderror" name="baths_num"
                                value="{{ $row->baths_num }}" required>
                ...
                <div class="form-group ">
                    ...
                    <input id="dimensionss" type="number"
                        class="form-control @error('dimensionss') is-invalid @enderror" name="dimensionss"
                        value="{{ $row->dimensionss }}" required placeholder="M2">
