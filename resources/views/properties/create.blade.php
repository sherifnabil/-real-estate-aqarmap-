        ...
        <form action="{{ route('properties.store') }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" multiple="multiple" name="extra_images[]" value="{{ old('extra_images') }}"
                        class="form-control">
                </div>
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='datetimepicker1'>
                                <input type='text' id='mydatetimepicker1' name="will_be_available_on" required class="form-control @error('will_be_available_on') is-invalid @enderror" value="{{ old('will_be_available_on') }} " />
                ...
                <div class="form-group ">
                    ...
                    <select name="status" class="form-control">
                        ...
                        @foreach ($status as $k => $v)
                            <option {{ old('status') == $k ? 'selected' : '' }} value="{{ $k }}">{{ $v }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group ">
