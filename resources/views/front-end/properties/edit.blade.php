...
<div class="container ">
        ...
        <form action="{{ route('update.property', $row) }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="contact" type="text" class="form-control @error('contact') is-invalid @enderror"
                    name="contact" value="{{ $row->contact }}" required>
            ...
            <div class="form-group ">
                ...
                <input id="floors_num" type="number" class="form-control @error('floors_num') is-invalid @enderror"
                    name="floors_num" value="{{ $row->floors_num }}" required>
            ...
            <div class="form-group ">
                ...
                <input id="rooms_num" type="number" class="form-control @error('rooms_num') is-invalid @enderror"
                    name="rooms_num" value="{{ $row->rooms_num }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='datetimepicker1'>
                            <input type='text' id='datetimepicker1' name="will_be_available_on" required
            ...
            <div class="col-md-6">
                ...
                <div class="form-group ">
                    ...
                    <input id="baths_num" type="number" class="form-control @error('baths_num') is-invalid @enderror"
                        name="baths_num" value="{{ $row->baths_num }}" required>
            ...
            <div class="form-group ">
                ...
                <input id="dimensionss" type="number" class="form-control @error('dimensionss') is-invalid @enderror"
                    name="dimensionss" value="{{ $row->dimensionss }}" required placeholder="M2">
            ...
            <div class="form-group ">
                ...
                <select name="category_id" class="form-control">
                   ...
                   @foreach ($categories as $category)
                    <option {{  $category->id == $row->category_id ? 'selected' : '' }} value="{{ $category->id }}">
            ...
            <div class="form-group ">
                ...
                <select name="property_type_id" class="form-control">
                   ...
                   @foreach ($property_types as $p)
                    <option {{ $row->property_type_id == $p->id ? 'selected' : '' }} value="{{ $p->id }}">
                        {{ $p->name }}</option>
                    @endforeach
                </select>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="primary-btn order-submit pull-right">{{ $title }}</button>
    </div>
    </form>
    <br><br>
</div>
