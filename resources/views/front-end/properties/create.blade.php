    ...
    <div class="billing-details">
        ...
        <form action="{{ route('store.property') }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="file" multiple="multiple" value="{{ old('extra_images') }}" name="extra_images[]" class="form-control">
            </div>
            ...
            <div class="form-group ">
                ...
                <input id="floors_num" type="number" class="form-control @error('floors_num') is-invalid @enderror"
                    name="floors_num" value="{{ old('floors_num') }}" required>
            ...
            <div class="form-group ">
                ...
                <input id="rooms_num" type="number" class="form-control @error('rooms_num') is-invalid @enderror" name="rooms_num"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group ">
                        ...
                        <input id="baths_num" type="number" class="form-control @error('baths_num') is-invalid @enderror"
                            name="baths_num" value="{{ old('baths_num') }}" required>
            ...
            <div class="form-group ">
                ...
                <input id="dimensionss" type="number" class="form-control @error('dimensionss') is-invalid @enderror"
                    name="dimensionss" value="{{ old('dimensionss') }}" required placeholder="M2">
