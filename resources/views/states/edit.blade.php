...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ route('states.update', $row) }}" method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="city_id" id="" class="form-control">
                        ...
                        @foreach ($cities as $city)
                            <option value="{{ $city->id }}" {{ $city->id == $row->city_id ? 'selected' : '' }}>{{ $city->name }}</option>
                        @endforeach
