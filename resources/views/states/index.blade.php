            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('custom.main_image')</th>
                        <th>@lang('custom.city')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('states.edit', $row) }}" class="btn btn-primary"> <i class="fa fa-edit"></i></a></td>
                        <td>
                            <form action="{{ route('states.destroy', $row) }}" method="POST">
                                @method('DELETE')
                                @csrf
