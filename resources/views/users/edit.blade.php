        ...
        <form action="{{ route('users.update', $row) }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ $row->first_name }}" required autocomplete="first_name" autofocus>
                </div>

                <div class="form-group">
                    <label>{{ __('custom.last_name') }}: </label>
                    <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ $row->last_name }}" required autocomplete="last_name">
                </div>
                ...
                <div class="form-group">
                    <img src="{{ $row->profilImage() }}" class="img-thumbnail image-preview"  style="width:250px; height:200px">
                </div>
                ...
                <div class="form-group ">
                    ...
                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $row->phone }}" required autocomplete="phone">
                </div>

                <div class="form-group ">
                    <label>{{ __('custom.address') }}: </label>
                    <input id="address" type="text" class="form-control @error('address') is-invalid @enderror"  name="address" value="{{ $row->address }}" required autocomplete="address">
                </div>
