        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="{{ asset('/') }}" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ !empty(auth()->user()->profilImage()) ? auth()->user()->profilImage() : '' }}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ route('users.profile', auth()->user()) }}" class="btn btn-default btn-flat">{{ __('custom.profile') }}</a>
                            </div>
